# NextCloudShot Nextcloud app

Optional web companion for NextCloudShot Desktop. Install it as `custom_apps/cloudshot`, run `npm install && npm run build`, and enable it with `php occ app:enable cloudshot`.
